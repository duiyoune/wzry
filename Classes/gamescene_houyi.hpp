...
class houyi:public Scene
{
public:
    static Scene * gamescene_houyi();
};
...
class set_houyi:public Layer
{
public:
    virtual bool init();
    CREATE_FUNC(set_houyi);
    Sprite * equipment;
    void onMouseDown(Event * event);
public:
    int equip_number=-1;
